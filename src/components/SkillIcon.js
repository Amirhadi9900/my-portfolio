...
function VSCodeIcon({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="#007ACC" aria-hidden="true">
      <path d="M23.15 2.587L18.21.21a1.494 1.494 0 0 0-1.705.29l-9.04 8.19-3.43-3.258a1.003 1.003 0 0 0-1.276-.057L.327 7.261A1 1 0 0 0 .326 8.74L3.899 12 .326 15.26a1 1 0 0 0 .001 1.479L1.74 18.84a1.003 1.003 0 0 0 1.276-.057l3.43-3.258 9.04 8.19a1.492 1.492 0 0 0 1.704.29l4.942-2.377A1.5 1.5 0 0 0 24 20.06V3.939a1.5 1.5 0 0 0-.85-1.352zm-3.146 14.861L10.826 12l9.178-5.448v10.896z" />
    </svg>
  );
}
